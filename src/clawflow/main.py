...
from src.clawflow.agents.agent import AgentState
from src.clawflow.config import env
from src.clawflow.utils import truncate
from src.clawflow.agents import build_llm, build_reflection_multi_agent_graph

def setup_logging(level=logging.INFO):
    # Key: configure logging here
    logging.basicConfig(
        level=level,
...
if __name__ == "__main__":
    ...
    os.environ["WORKSPACE_ROOT"] = str(utils.get_workspace_root())
    ...
    async def main_entry():
        ...
        from src.clawflow.agents import init_mcp_tools
